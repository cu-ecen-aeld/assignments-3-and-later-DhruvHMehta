...
WRITER_PATH=/home/dhruv/Documents/AESD/GitHub/Assignment_1/assignment-1-DhruvHMehta/finder-app
...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    echo "Cleaning up using mproper and running defconfig"
    ...
    echo "Building modules and dtbs"
...
echo "Make 1 complete"
make ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE} CONFIG_PREFIX=${OUTDIR}/rootfs install
echo "Make 2 complete"
...
echo "Copying finder.sh and conf"
